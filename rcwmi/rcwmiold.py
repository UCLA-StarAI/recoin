    ...
    def compensating_potentials(self, n_comp_lits):
        ...
        for k in self.relaxations:
            ...
            if x not in comp_pots:
                # REM model for 'x'
                rem = MPWMI(self.primal.get_univariate_formula(x), Real(1))
...
if __name__ == '__main__':
    ...
    for n_comp_lits in xs:
        ...
        for _ in range(REPEAT):
            ...
            rcmi = RCWMIold(f, w, n_comp_lits=n_comp_lits, rand_gen=rand_gen, max_compensate_iters=MAX_ITERS)
